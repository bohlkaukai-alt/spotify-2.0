...
export default function Layout({ onFullscreen }) {
  ...
  const navItems = [
    ...
    { to: '/library', icon: Library, label: 'Deine Bibliothek' },
  ];
  ...
  return (
    <div className="flex flex-col h-screen bg-black">
      ...
      <div className="hidden md:flex flex-1 gap-2 p-2 pb-0 overflow-hidden">
        ...
        {/* Main Content */}
        <main className="flex-1 bg-[#121212] rounded-lg overflow-y-auto relative"
          style={{ scrollbarWidth: 'thin', scrollbarColor: 'hsla(0,0%,100%,.3) transparent' }}>
          {/* Top Bar */}
          <div className="sticky top-0 z-30 flex items-center gap-4 px-6 py-4 bg-[#121212]/80 backdrop-blur-xl">
            ...
            <div className="flex-1 max-w-md">
              <div className="relative">
                <Search size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-black/60" />
      ...
      <div className="md:hidden flex flex-col h-screen">
        {/* Mobile Top Bar */}
        <div className="flex items-center justify-between px-4 py-3 bg-[#121212] safe-top shrink-0">
        ...
        <main className="flex-1 overflow-y-auto bg-[#121212]"
          style={{ paddingBottom: 'calc(56px + 70px + env(safe-area-inset-bottom, 0px))' }}>
          <Outlet />
        </main>
        ...
        {/* Mobile Bottom Nav */}
        <nav className="fixed bottom-0 left-0 right-0 bg-[#121212] border-t border-white/5 flex items-center justify-around py-2 z-40"
